    ...
    <div class="container" style="padding:100px;">
      <div class="row">
          ...
          <div class="page-header">
            <h2 class="specialHead">Votaciones.</h2>
          </div>
          <?php
            // Set session variables
            $_SESSION["presidente"] = null;
            $_SESSION["alcalde"] = null;
            $_SESSION["senador"] = null;
            $_SESSION["diputado"] = null;
            $_SESSION["eleccion"] = 1;
          ?>
          <form action="votacion/index.php" method="POST">
          <div class="form-group">

            <label>Cedula:</label><br>
            <input id="id1" type="text" name="voterID" placeholder="Ingresa tu cedula" class="form-control" required/><br>
